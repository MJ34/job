            ...
            <div class="panel-body">
                <form:form class="form-horizontal" action="${pageContext.request.contextPath}/company/job-notices/saveJobNotice" modelAttribute="jobNotice">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Job Title</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Select</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Work Type</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Job Detail</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
