            ...
            <div class="panel-body">
                <form:form class="form-horizontal" action="${pageContext.request.contextPath}/updateUser" modelAttribute="currentUser">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Username</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
                            <form:input type="text" disabled="true" class="form-control" id="username" path="username"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Password</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">User Type</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
