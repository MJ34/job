...
"></div>
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" id="sidenav-main">
    <div class="sidenav-header" style="margin-left: -25px;">
      ...
      <a class="navbar-brand m-0" href="${pageContext.request.contextPath}/company/main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="${pageContext.request.contextPath}/company/main">
        ...
        <li class="nav-item">
          <a class="nav-link " href="${contextPath}/company/job-notices">
            ...
            <span class="nav-link-text ms-1 ml-2 font-weight-bold text-dark">Job</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="#">
            ...
            <span class="nav-link-text ms-1 ml-2 font-weight-bold text-dark">Candidate</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="#">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <img src="https://img.icons8.com/bubbles/45/000000/video-conference.png"/>
            </div>
            <span class="nav-link-text ms-1 ml-2 font-weight-bold text-dark">Test</span>
          </a>
        </li>
         <li class="nav-item">
